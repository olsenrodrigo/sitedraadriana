...
export default function Footer() {
  ...
  return (
    <footer className="text-white py-12" style={{ backgroundColor: "#3A3A3A" }}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-base transition-colors hover:text-white" style={{ color: "#EFF5F7" }}>
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-base transition-colors hover:text-white" style={{ color: "#EFF5F7" }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-3 text-base" style={{ color: "#EFF5F7" }}>
              ...
              <li><a href="#services" className="hover:text-white transition-colors">Tratamentos da Dor</a></li>
              <li><a href="#treatments" className="hover:text-white transition-colors">Procedimentos</a></li>
        ...
        <div className="border-t pt-8 text-center" style={{ borderColor: "rgba(239, 245, 247, 0.2)" }}>
          <p className="text-base flex items-center justify-center gap-2" style={{ color: "#EFF5F7" }}>
            &copy; {currentYear} Dra. Adriana Macari. Todos os direitos reservados. Feito com
            <Heart size={16} className="fill-current" style={{ color: "#2B7A8E" }} />
          </p>
        </div>
      </div>
    </footer>
